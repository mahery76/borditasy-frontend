...
export class LbdChartComponent implements OnInit, AfterViewInit {
  ...
  @Input()
  public title: string = ''; // Initialize title with a default value
  ...
  @Input()
  public chartType!: ChartType; // Use definite assignment assertion
  ...
  @Input()
  public legendItems: LegendItem[] = []; // Initialize with an empty array

  @Input()
  public withHr: boolean = true;
